  ...
  tabs: [
    {
	  ...
	  disableIconTint: true, // optional, by default the image colors are overridden and tinted to tabBarButtonColor, set to true to keep the original image colors
